...
#Judy Note: I added this loop to print each business record returned by Yelp to the console, parse the house number and street name, and load records into PostgreSQL
    ...
    with open(jsonfile + 'yelp50.json', 'wb') as f:
     ...
     #       print(business['location']['address1'])
            ...
            #Judy Note: Use Python pyparsing library to split address per Alan recommendation
            ...
            s_rank = '0'
            #s_review_count = '0'
            s_review_count = business['review_count']
            #s_rating = '0'
            s_rating = business['rating']
            ...
            SQL = "INSERT INTO blockadvisor_location(location_id, business_name, address, street_number, street_name, rank, review_count, rating, categories)  VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s) RETURNING id;"
            cur.execute(SQL, (loc_id, business_name, address, house_number, street_name, s_rank, s_review_count, s_rating, categories))
            con.commit()
