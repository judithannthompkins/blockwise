...
'''
        ...
        SQL = "INSERT INTO blockadvisor_location(location_id, business_name, address, street_number, street_name, rank, review_count, rating)  VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);"
